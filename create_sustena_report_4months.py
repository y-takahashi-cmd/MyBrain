...
data = [
    ...
    ['浅野 航さん',
     '3/17・3/27\n5/22（計3回）',
     '心理状態96%と高水準を維持。責任ある仕事を担い始め、一定の成長実感を積んだことで、次のステージへの意識が高まっています。「この1〜2年で自信がついてきた」と自己評価。現在の生活満足度70〜75%で安定した状態。',
     '【分析】\n浅野さんが現在最も重視しているのは「30代という時間の中で、いかに成長できる仕事・環境に出会えるか」という点です。この段階で会社が明確なビジョンと期待値を示せるかどうかが、定着の分岐点になります。\n\n【会社に必要なアクション】\n「あなたはここにいたら何ができるようになるか」「会社はあなたに何を期待しているか」を明確に言葉で伝えることが最も重要です。\n①「2年後にこういう役割を担ってほしい」という具体的な期待値を上司から直接伝える\n②企画・調整・外部コミュニケーションを担うポジションを明文化し、役割定義を行う\n③月1回、佐藤社長との1on1を設定し、定期的なビジョン共有の場を作る\n④半年〜1年のキャリアパスを明文化して共有する'],
    ['樋田 雅史さん',
     '3月・4/3\n4/24・5/22\n（計4回）',
     '初回は慢性的な体調不良により本来の思考力・判断力が十分に発揮できない状態でした。4回のセッションを通じて体調が確実に改善。笑顔の出方・エネルギーの質が変化し、5/22に最も顕著な変化が見られました。卓球の教え子が県大会進出→朝2回自然に早起きができるほどに。',
     '【分析】\n他者に対しては「できていること」を自然に見られる方ですが、自分自身に対しては「できていないこと」だけに目が向き、自責する思考癖があります。また「言葉にして完了を確認しない限り、未完了として抱え続ける」という頭の癖があります。この思考パターンの改善が、体調・仕事のパフォーマンス向上に直結する重要なテーマです。\n\n【会社・上司に必要なアクション】\n以下の順番で定期的に声をかけることが効果的です。\n①「順調に進んでいますか？」\n②「できていることは何ですか？」\n③「順調に進むために、あと何をやったらよいですか？」\nこの順番で話す場を作ることで頭の整理がしやすくなります。「できたこと」を言葉にして確認する機会を設けることで、慢性的な「未完了感」が軽減し、前向きに仕事に取り組める状態に近づいていきます。'],
    ['佐藤 洋介さん',
     '4/10・4/17\n6/19（計3回）',
